 ...
 *  \
 */
public class YiSQLPreparedStatement implements PreparedStatement {
  ...
  public YiSQLPreparedStatement(String sql, YiSQLConnection conn) {
    this.conn = conn;
    this.sql = sql;
  }

  private void executeForResultSet() throws SQLException {
    if (isClosed) {
