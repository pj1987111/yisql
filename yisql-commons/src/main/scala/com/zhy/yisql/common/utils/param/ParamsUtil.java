package com.zhy.yisql.common.utils.param;
...
interface ParamPairParseIm {
    ...
    int parse(char[] paramsCharArray, int start, Map<String, String> collector);
}

interface ParamOnlyParseIm {

    int parse(char[] paramsCharArray, int start, StringBuilder collector);
}
