...
public interface DSLSQLVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link DSLSQLParser#complete}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitComplete(DSLSQLParser.CompleteContext ctx);
	/**
	 * Visit a parse tree produced by {@link DSLSQLParser#update}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitUpdate(DSLSQLParser.UpdateContext ctx);
	/**
