package com.zhy.yisql.addon.cmd.hdfs;

import com.zhy.yisql.common.utils.hdfs.*;
...
public class HdfsFsShell extends Configured implements Tool {

    static final Log LOG = LogFactory.getLog(HdfsFsShell.class);
     ...
     */
    public HdfsFsShell(Configuration conf, String basePath) {
        super(conf);
    ...
    protected void init() throws IOException {
        ...
        if (commandFactory == null) {
            ...
            commandFactory.addObject(new Help(getConf(), basePath, out, error), "-help");
            commandFactory.addObject(new Usage(getConf(), basePath, out, error), "-usage");
